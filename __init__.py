...
elements = {
 ...
 3 : { 'mass' : 6.941, 'name': 'Lithium', 'symb': 'Li' }, 
 4 : { 'mass' : 9.0122, 'name': 'Beryllium', 'symb': 'Be' }, 
 5 : { 'mass' : 10.811, 'name': 'Boron', 'symb': 'B' }, 
 6 : { 'mass' : 12.0107, 'name': 'Carbon', 'symb': 'C' }, 
 7 : { 'mass' : 14.0067, 'name': 'Nitrogen', 'symb': 'N' }, 
 8 : { 'mass' : 15.9994, 'name': 'Oxygen', 'symb': 'O' }, 
 9 : { 'mass' : 18.9984, 'name': 'Fluorine', 'symb': 'F' }, 
 10 : { 'mass' : 20.1797, 'name': 'Neon', 'symb': 'Ne' }, 
 11 : { 'mass' : 22.9897, 'name': 'Sodium', 'symb': 'Na' }, 
 12 : { 'mass' : 24.305, 'name': 'Magnesium', 'symb': 'Mg' }, 
 13 : { 'mass' : 26.9815, 'name': 'Aluminum', 'symb': 'Al' }, 
 14 : { 'mass' : 28.0855, 'name': 'Silicon', 'symb': 'Si' }, 
 15 : { 'mass' : 30.9738, 'name': 'Phosphorus', 'symb': 'P' }, 
 16 : { 'mass' : 32.065, 'name': 'Sulfur', 'symb': 'S' }, 
 17 : { 'mass' : 35.453, 'name': 'Chlorine', 'symb': 'Cl' }, 
 18 : { 'mass' : 39.948, 'name': 'Argon', 'symb': 'Ar' }, 
 19 : { 'mass' : 39.0983, 'name': 'Potassium', 'symb': 'K' }, 
 20 : { 'mass' : 40.078, 'name': 'Calcium', 'symb': 'Ca' }, 
 21 : { 'mass' : 44.9559, 'name': 'Scandium', 'symb': 'Sc' }, 
